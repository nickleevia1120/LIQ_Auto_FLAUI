LIQ_DashBoard_Window = '/Window[contains(@Name, "Fusion Loan IQ - Loan iq05 User 05 - Business Date: 18-Jun-2013")]'
...
LIQ_DashBoard_Window_TreeItem_Actions_Pane = '((/Window[2]/Pane)/Pane[5]/Tree)/TreeItem'
...
LIQ_DashBoard_Window_Locators = {
    ...
    'Favorites TreeItem': LIQ_DashBoard_Window_Tree_Favorites_Pane + '//TreeItem[contains(@Name, "[Favorites]")',
    'Actions TreeItem': LIQ_DashBoard_Window_TreeItem_Actions_Pane + '//TreeItem[contains(@Name, "[Actions]")',
